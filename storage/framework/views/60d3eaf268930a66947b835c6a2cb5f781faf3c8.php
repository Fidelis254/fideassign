											...
											<td data-th="Action">
												<span class="bt-content">
													<div class="wt-actionbtn">
														...
														<a href="<?php echo e(url('freelancer/service/'.$service->id.'/'.$order->status)); ?>" class="wt-addinfo wt-skillsaddinfo">
														...
														<?php if($order->status == 'cancelled' && Helper::getOrderPayout($order->id)->count() == 0): ?>
															...
															<b-modal ref="myModalRef-<?php echo e($order->id); ?>" hide-footer title="Refund" v-cloak>
																<div class="d-block text-center">
																	<?php echo Form::open(['url' => '', 'class' =>'wt-formtheme', 'id' => 'submit_refund_'.$order->id,  '@submit.prevent'=>'submitRefund']); ?>

																		<fieldset>
																			<div class="form-group">
																				<span class="wt-select">
																					<select name="refundable_user_id" class="form-control" placeholder="<?php echo e(trans('lang.select_users')); ?>" v-model="refundable_user">
																			...
																			<div class="form-group">
																				<span class="wt-select">
																					<?php echo Form::select('payment_method', $payment_methods, null, array('class' => 'form-control', 'placeholder' => trans('lang.select_pay_method'), 'v-model' => 'refundable_payment_method')); ?>

																				</span>
																			</div>
																			<input type="hidden" value="<?php echo e($service->price); ?>" id="refundable-amount" name="proposal_amount">
																			<input type="hidden" value="<?php echo e($order->id); ?>" id="refundable-order-id" name="order_id">
