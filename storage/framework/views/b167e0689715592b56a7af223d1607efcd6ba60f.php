                                    ...
                                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <b-modal ref="myModalRef-<?php echo e($job->id); ?>" hide-footer title="Refund" v-cloak>
                                            <div class="d-block text-center">
                                                <?php echo Form::open(['url' => '', 'class' =>'wt-formtheme', 'id' => 'submit_refund_'.$job->id,  '@submit.prevent'=>'submitRefund']); ?>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <?php if(!empty($cancel_proposal)): ?>
                                                            <input type="hidden" value="<?php echo e($cancel_proposal->amount); ?>" id="refundable-amount" name="proposal_amount">
                                                            <input type="hidden" value="<?php echo e($cancel_proposal->id); ?>" id="refundable-order-id" name="order_id">
                                                        <?php endif; ?>
                                                        <input type="hidden" value="<?php echo e($job->id); ?>" id="refundable-job-id" name="job_id">
