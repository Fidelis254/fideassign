                                            ...
                                            <div class="wt-followedcompnies">
                                                <div class="wt-userlistinghold wt-userlistingsingle">
                                                    <figure class="wt-userlistingimg">
                                                        <img src="<?php echo e(asset($profile_image)); ?>" alt="image description">
                                                    </figure>
                                                    <div class="wt-userlistingcontent">
                                                        <div class="wt-contenthead wt-followcomhead">
                                                            <div class="wt-title">
                                                                <a href="<?php echo e(url('profile/'.$emp->slug)); ?>">
                                                                    <?php if($verified_user === 1): ?>
                                                                        <i class="fa fa-check-circle"></i> <?php echo e(trans('lang.verified_company')); ?></a>
                                                                    <?php endif; ?>
                                                                <h3><a href="<?php echo e(url('profile/'.$emp->slug)); ?>"><?php echo e($user_name); ?></a></h3>
                                                            </div>
                                                            <ul class="wt-followcompomy-breadcrumb wt-userlisting-breadcrumb">
                                                                <li><a href="<?php echo e(url('profile/'.$emp->slug)); ?>"> <?php echo e(trans('lang.open_jobs')); ?>  </a></li>
                                                                <li><a href="<?php echo e(url('profile/'.$emp->slug)); ?>"> <?php echo e(trans('lang.full_profile')); ?></a></li>
                            ...
                            <div class="wt-addprojectsholder wt-likefreelan la-likefreelanfav">
                                ...
                                <div class="wt-likedfreelancers wt-haslayout">
                                    <?php $__currentLoopData = $saved_freelancers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $freelancer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <div class="wt-userlistinghold <?php echo e($featured_class); ?>">
                                            <?php if( !empty($job->is_featured) && $job->is_featured == 'true'): ?>
                                                <span class="wt-featuredtag"><img src="<?php echo e(asset('images/featured.png')); ?>" alt="<?php echo e(trans('ph.is_featured')); ?>" data-tipso="Plus Member" class="template-content tipso_style"></span>
                                            <?php endif; ?>
                                            <figure class="wt-userlistingimg">
                                                ...
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        <a href="<?php echo e(url('profile/'.$user->slug)); ?>">
                                                            <?php if($verified_user === 1): ?> <i class="fa fa-check-circle"></i> <?php endif; ?>
                                                    ...
                                                    <ul class="wt-userlisting-breadcrumb">
                                                        ...
                                                        <?php endif; ?>
                                                        <li><span><img src="<?php echo e(asset(Helper::getLocationFlag($user->location->flag))); ?>" alt="<?php echo e(trans('lang.locations')); ?>"> <?php echo e($user->location->title); ?></span></li>
