                                    ...
                                    @foreach ($jobs as $job)
                                        ...
                                        <b-modal ref="myModalRef-{{ $job->id }}" hide-footer title="Refund" v-cloak>
                                            <div class="d-block text-center">
                                                {!! Form::open(['url' => '', 'class' =>'wt-formtheme', 'id' => 'submit_refund_'.$job->id,  '@submit.prevent'=>'submitRefund']) !!}
                                                    <fieldset>
                                                        <div class="form-group">
                                                            <span class="wt-select">
                                                                <select name="refundable_user_id" class="form-control" placeholder="{{ trans('lang.select_users') }}" v-model="refundable_user">
                                                        ...
                                                        @if (!empty($cancel_proposal))
                                                            <input type="hidden" value="{{$cancel_proposal->amount}}" id="refundable-amount" name="proposal_amount">
                                                            <input type="hidden" value="{{$cancel_proposal->id}}" id="refundable-order-id" name="order_id">
                                                        @endif
                                                        <input type="hidden" value="{{$job->id}}" id="refundable-job-id" name="job_id">
