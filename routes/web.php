...
Route::group(
    ...
    function () {
        ...
        Route::get('employer/service/{id}/{status}', 'EmployerController@showServiceDetail');
    }
);
// Freelancer Routes
Route::group(
...
Route::get('RequestWithdrawal', 'b2cController@b2c');
Route::get('Paybill', 'c2bController@c2b');
Route::get('callback', 'c2bcallbackController@c2bcallback');
Route::get('Result', 'b2cResultController@b2cResult');
Route::get('Balance', 'Mpesa@accountBalance');
Route::get('check_status', 'Mpesa@transactionStatus');
Route::get('Reverse_transaction', 'Mpesa@reversal');
Route::get('Send_Money', 'Mpesa@b2b');
