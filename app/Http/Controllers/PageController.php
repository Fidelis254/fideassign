    ...
    public function show($slug)
    {
        if (!empty($slug)) {
            ...
            if (file_exists(resource_path('views/extend/front-end/pages/show.blade.php'))) {
                return View::make('extend.front-end.pages.show', compact('page', 'slug', 'meta_desc', 'banner', 'show_banner', 'show_banner_image'));
            } else {
                return View::make('front-end.pages.show', compact('page', 'slug', 'meta_desc', 'banner', 'show_banner', 'show_banner_image'));
            }
        }
    }
