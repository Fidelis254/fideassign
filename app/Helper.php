...
class Helper extends Model
{
    ...
    public static function getPaymentMethodList($key = " ")
    {
        $list = array(
            'Mpesa' => array(
                'title' => trans('lang.payment_methods.Mpesa'),
                'value' => 'Mpesa',
            ),
            'paypal' => array(
    ...
    public static function updatePayouts()
    {
        ...
        $payment_gateway = !empty($payout_settings) && !empty($payout_settings[0]['payment_method']) ? $payout_settings[0]['payment_method'] : 'Mpesa';
